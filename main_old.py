...
async def fetch_doc_dfs(insert_document: any):
  print("total content of tree", collection.find_one())
  for child in insert_document.children:
    fetch_doc_dfs(child)
...
#   }
#   }  
#     result_tree = await collection.insert_one(insert_this)
#     return result_tree
